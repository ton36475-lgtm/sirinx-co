...
export class OpenClawOrchestrator {
   ...
   */
  async route(task: string, options: RouteOptions = {}): Promise<any> {
    try {
   ...
   */
  async parallel(tasks: ParallelTask[]): Promise<any> {
    try {
   ...
   */
  async cascade(task: string, options: CascadeOptions): Promise<any> {
    try {
   ...
   */
  async critique(task: string, options: CritiqueOptions): Promise<any> {
    try {
