...
| **Premium (5%)** | Claude Opus 4.6, GPT-4 Turbo, Kimi K3 (official `moonshotai/kimi-k3`) | 5% | ~70 THB | Approver — final sign-off, strategy, financial calculations |
...
Long-horizon coding / 1M context → Kimi K3 (`moonshotai/kimi-k3`, approval-gated lane)
