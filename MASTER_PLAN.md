...
| A11 | External Postman workspace/collection reference recorded for the four API surfaces; no collection artifact or current external-access receipt is stored in this repo. | collection reference `e6b5fcae…`; current accessibility **UNVERIFIED** |
