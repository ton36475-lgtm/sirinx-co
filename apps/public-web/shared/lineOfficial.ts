export const lineOfficialConfig = {
  ...
  defaultMessage:
    "สวัสดีครับ สนใจให้ SIRINX ประเมินระบบ Solar Carport / Rooftop Solar / BESS / EV Charger เบื้องต้นครับ",
  purpose:
    "ส่งบิลค่าไฟ รูปพื้นที่ ขอประเมิน Solar Carport / Rooftop Solar / BESS / EV Charger และ AI Energy Management",
  qrAltText: "QR Code สำหรับเพิ่มเพื่อน LINE Official ของ SIRINX",
} as const;
