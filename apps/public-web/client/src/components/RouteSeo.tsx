...
export default function RouteSeo() {
  ...
  // The static document and this effect share metadata ownership. Rendering the
  // same canonical through Helmet/React 19 creates React-owned head nodes that
  // imperative deduplication can detach before React removes them on navigation.
  // Page-specific structured data remains in each page's Helmet.
  return null;
}
