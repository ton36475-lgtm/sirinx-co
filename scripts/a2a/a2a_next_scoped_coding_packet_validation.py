#!/usr/bin/env python3
"""Run allowlisted validation for the active A2A2A next scoped coding packet."""
...
DEFAULT_FIXTURE_PATH = FIXTURE_DIR / "a2a2aNextScopedCodingPacketValidation.json"
...
def command_specs() -> list[dict[str, Any]]:
    return [
        {
            "id": "glm52_ui_benchmark_tests",
            "cmd": ["python3", "-m", "unittest", "tests.model_eval.test_glm52_ui_review_benchmark"],
        },
        {
        ...
        {
            "id": "prettier_check_glm52_ui_benchmark",
            "cmd": [
                "pnpm",
                "exec",
                "prettier",
        ...
        {
            "id": "python_compile_glm52_ui_benchmark",
            "cmd": [
                "python3",
                "-m",
                "py_compile",
        ...
        {
            "id": "json_parse_glm52_ui_benchmark_fixtures",
            "cmd": [
                "python3",
                "-c",
                (
                    "import json, pathlib; "
                    "files=['apps/mission-control/src/fixtures/a2a2aNextScopedCodingPacket.json',"
                    "'apps/mission-control/src/fixtures/glm52UiBenchmarkStatus.json']; "
        ...
        {
            "id": "git_diff_check_glm52_ui_benchmark_paths",
...
def build_validation(packet_fixture: dict[str, Any], runtime_root: Path, dry_run: bool = False) -> dict[str, Any]:
    ...
    packet_ready = (
        summary.get("status") == "ready_for_scoped_coding_packet"
    ...
    validation = {
        "updatedAt": now_iso(),
        "mode": "local_allowlisted_next_scoped_coding_packet_validation",
        "generatedBy": "scripts/a2a/a2a_next_scoped_coding_packet_validation.py",
    ...
    runtime_report_path = runtime_root / "next_scoped_coding_packet_validations" / "latest.json"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate A2A2A next scoped coding packet")
